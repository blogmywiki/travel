<?php
  ...
  $OpenLDBWS = new OpenLDBWS("51e1b1e3-566d-44dc-bdde-532c0489918c");
...
// table 1
// print "Hither Green > London Bridge";
...
//    print "Hither Green > Peckham Rye";
...
var json_obj = JSON.parse(Get('https://api.tfl.gov.uk/StopPoint/490004257W/arrivals'));
...
document.writeln('<br /><br /><br /><br /><table><caption>Buses from Brandram Rd westbound</caption><tbody><thead><tr><th>route</th><th>Destination</th><th>Due</th></tr></thead>')
